...
const projects = [
  { id: 1, title: 'Engranaje Prototipo', material: 'ABS Industrial', span: 'col-span-1 row-span-1', img: '/images/project-1.png' },
  { id: 2, title: 'Maqueta Arquitectónica', material: 'PLA Blanco', span: 'col-span-1 md:col-span-2 row-span-1', img: '/images/project-2.png' },
  { id: 3, title: 'Figura Coleccionable', material: 'Resina 8K', span: 'col-span-1 row-span-2', img: '/images/project-3.png' },
  { id: 4, title: 'Carcasa Electrónica', material: 'PETG Negro', span: 'col-span-1 row-span-1', img: '/images/project-4.png' },
  { id: 5, title: 'Estructura Lattice', material: 'Resina Tenaz', span: 'col-span-1 row-span-1', img: '/images/project-5.png' },
  { id: 6, title: 'Jarrón Paramétrico', material: 'PETG Translúcido', span: 'col-span-1 md:col-span-2 row-span-1', img: '/images/project-6.png' },
  { id: 7, title: 'Brazo Robótico', material: 'Fibra de Carbono', span: 'col-span-1 row-span-1', img: '/images/project-7.png' },
  { id: 8, title: 'Miniatura Tabletop', material: 'Resina Gris', span: 'col-span-1 row-span-1', img: '/images/project-8.png' },
];
