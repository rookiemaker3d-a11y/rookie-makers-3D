...
from app.scheduler_notificaciones import start_scheduler
from app import models  # noqa: F401 - asegura que todas las tablas (incl. app_settings, audit_log) estén registradas antes de init_db
...
from app.api.inventario_filamento_routes import router as inventario_filamento_router
...
from app.api.suscripciones_routes import router as suscripciones_router
from app.api.web_assets_routes import router as web_assets_router
...
app.include_router(inventario_filamento_router, prefix="/api")
...
app.include_router(suscripciones_router, prefix="/api")
app.include_router(web_assets_router, prefix="/api")
...
app.mount("/web-assets", StaticFiles(directory=_assets_dir), name="web-assets")
