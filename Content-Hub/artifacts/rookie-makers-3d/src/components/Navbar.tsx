        ...
        <div className="md:hidden bg-background/95 backdrop-blur-xl border-b border-primary/20 px-4 pb-4">
          {links.map((l) => (
            <a
              ...
              className="block py-3 text-sm font-mono text-muted-foreground hover:text-primary transition-colors uppercase tracking-wider border-b border-border/30 last:border-0"
            >
              {l.label}
            </a>
          ))}
